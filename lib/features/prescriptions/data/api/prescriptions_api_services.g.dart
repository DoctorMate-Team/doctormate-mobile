...
part of 'prescriptions_api_services.dart';
...
class _PrescriptionsApiServices implements PrescriptionsApiServices {
  _PrescriptionsApiServices(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  getPrescriptionDetails(String appointmentId) async {
    ...
    final _options = _setStreamType<
      DoctorMateResponse<PrescriptionDetailsResponse>
    >(
